...
public interface ModelTable {
     ...
     * @param method GET方法。
     */
    void addGetMethod(Class<? extends Model> classZ, String name, Method method);
     ...
     * @param method SET方法。
     */
    void addSetMethod(Class<? extends Model> classZ, String name, Method method);
