...
package com.zoe.snow.word.dictionary;

import com.zoe.snow.word.dictionary.impl.DictionaryTrie;
 ...
 * 词典工厂
 ...
 指定方式一，编程指定（高优先级）：
      WordConfTools.set("dic.class", "com.zoe.snow.word.dictionary.impl.DictionaryTrie");
      WordConfTools.set("dic.path", "classpath:dic.txt");
 指定方式二，Java虚拟机启动参数（中优先级）：
      java -Ddic.class=com.zoe.snow.word.dictionary.impl.DictionaryTrie -Ddic.path=classpath:dic.txt
 指定方式三，配置文件指定（低优先级）：
      在类路径下的word.conf中指定配置信息
      dic.class=com.zoe.snow.word.dictionary.impl.DictionaryTrie
      dic.path=classpath:dic.txt
 如未指定，则默认使用词典实现类（com.zoe.snow.word.dictionary.impl.DictionaryTrie）和词典文件（类路径下的dic.txt）
 * @author 杨尚川
 */
public final class DictionaryFactory {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //test("com.zoe.snow.word.dictionary.impl.DictionaryTrie");
        test("com.zoe.snow.word.dictionary.impl.DoubleArrayDictionaryTrie");
    }
    ...
    private static final class DictionaryHolder{
        ...
        private static Dictionary constructDictionary(){
            try{
                ...
                String dicClass = WordConfTools.get("dic.class", "com.zoe.snow.word.dictionary.impl.TrieV4");
