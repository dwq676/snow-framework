...
package com.zoe.snow.word.recognition;

import com.zoe.snow.word.recognition.health.*;
...
public class RecognitionTool {
    ...
    public static boolean isNegative(final String text) {
        return NegativeWord.is(text);
    }

    public static boolean isPositive(final String text) {
        return PositiveWord.is(text);
    }

    public static boolean isHealthPosition(final String text) {
        return Position.is(text);
    }

    public static boolean isHealthAdj(final String text) {
        return Adj.is(text);
    }

    public static boolean isHealthAdv(final String text) {
        return Adv.is(text);
    }

    public static boolean isHealthPart(final String text) {
        return Part.is(text);
    }

    public static boolean isHeathAction(final String text) {
        return Action.is(text);
    }

    public static boolean isHealthSecretion(final String text) {
        return Secretion.is(text);
    }
