...
public class MessageAdapterHandler {
    ...
    public void handleMessage(EventMessage eem) {
        ...
        if (Validator.isEmpty(eem.getQueueName()) || Validator.isEmpty(eem.getExchangeName())) {
    ...
    protected void add(String queueName, String exchangeName, RabbitConsumer processor, CodecFactory codecFactory) {
        if (Validator.isEmpty(queueName) || Validator.isEmpty(exchangeName) || processor == null || codecFactory == null) {
