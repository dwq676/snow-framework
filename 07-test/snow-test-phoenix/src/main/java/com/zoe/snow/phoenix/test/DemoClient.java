...
public class DemoClient {
    ...
    /*private static CharsetDecoder m_decoder = null;

    public static void main(String[] args) throws TIOError, TException {
        String host = "10.8.208.104";
    ...
    private static void run(String host, int port) throws IOError, TException, IllegalArgument,
            AlreadyExists {
        ...
        //为将要读取的表名
        byte[] t = bytes("rdc_rawdata_mping");
        ...
        int scanner = client.scannerOpenWithStop(ByteBuffer.wrap(t), ByteBuffer.wrap(bytes("10000")), ByteBuffer.wrap(bytes("10009")),
                columnNames, null);
    ...
    private static final void printRow(TRowResult rowResult) {
    ...
    private static void printRow(List<TRowResult> rows) {
    ...
    private static String utf8(byte[] buf) {
        try {
            return m_decoder.decode(ByteBuffer.wrap(buf)).toString();
    ...
    static protected String host = "10.8.208.104";
